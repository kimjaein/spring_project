            ...
            <div class="span10 offset1">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-footer">
                        <a href="#" class="btn btn-success"><span class="glyphicon glyphicon-user"></span>사용자페이지</a>
                        <span class="pull-right">
                            <a href="#" class="btn btn-info"><span class="glyphicon glyphicon-user"></span>친구추가</a>
                            <a href="#" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span>친구삭제</a>
                        </span>
                    </div>
                </div>
            </div>
